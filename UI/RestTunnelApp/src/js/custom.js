...
$(document).ready(function() {
    ...
    // setTimeout(sparkline_charts, 1000);
    // $('.boxchart').bind("DOMSubtreeModified", sparkline_charts);
...
function charts(alamsData, axisData) {
    ...
    if ($("#facebookChart").length) {
        ...
        var plot = $.plot($("#facebookChart"), [{ data: likes, label: "Fans" }], {
            series: {
                lines: {
                    show: true,
                    lineWidth: 2,
    ...
    if ($("#twitterChart").length) {
        ...
        var plot = $.plot($("#twitterChart"), [{ data: followers, label: "Followers" }], {
            series: {
                lines: {
                    show: true,
                    lineWidth: 2,
    ...
    if ($("#stats-chart").length) {
        ...
        var plot = $.plot($("#stats-chart"), [{ data: visitors, label: "visitors" }], {
            series: {
                lines: {
                    show: true,
                    lineWidth: 3,
